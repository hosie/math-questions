...
.factory('default26TopicDistributionTable',function(){
  ...
  var inputTable=[
    ...
    [24,1,2,25,6,5,25,9,10,25,13,14,25,18,17,25,21,22,25,25,26,25,3,4,25,7,8,25,12,11,25,15,16,25,19,20,25,24,23,25],
    [26,3,4,26,7,8,26,12,11,26,15,16,26,19,20,26,24,23,26,1,2,26,6,5,26,9,10,26,13,14,26,18,17,26,21,22,26,25,26,26]
  ];
  var outputTable=[];
  for(var weekIndex=0;weekIndex<1;weekIndex++){
    var nextWeek=[];
...
.factory('default32TopicDistributionTable',function(){
    ...
    [
      ...
      [ 24,23,24,19,20,21,16,17,18,13,14,15,10,11,12,7,8,9,4,5,6,1,2,3,31,32,30,27,28,29,24,25,26,21,22,23,18,19,20,15],
      [ 27,26,27,22,23,24,19,20,21,16,17,18,13,14,15,10,11,12,7,8,9,4,5,6,1,2,3,31,32,30,27,28,29,24,25,26,21,22,23,18],
